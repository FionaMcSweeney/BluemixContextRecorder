...
public final class ContextRecorderApplication extends Application {
	private static final String APP_ID = "applicationID";
	private static final String APP_SECRET = "applicationSecret";
	private static final String APP_ROUTE = "applicationRoute";
	private static final String PROPS_FILE = "contextrecorder.properties";
	public static final int EDIT_ACTIVITY_RC = 1;
	private static final String CLASS_NAME = ContextRecorderApplication.class
			.getSimpleName();
	List<Context> itemList;

	@SuppressLint("NewApi")
	public ContextRecorderApplication() {
	...
	public void onCreate() {
		super.onCreate();
		itemList = new ArrayList<Context>();
	 ...
	 * @return itemList
	 */
	public List<Context> getItemList() {
		return itemList;
	}
}
